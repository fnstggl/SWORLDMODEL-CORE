...
def test_corpus_authored_uncited_fact_still_blocks() -> None:
    """The filter is live-compilation only. A corpus that *declares* an uncited required
    fact must still be refused, so the integrity gate itself is unchanged."""
