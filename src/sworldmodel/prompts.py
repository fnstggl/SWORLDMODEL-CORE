    ...
    * The actor is told **what it was already doing**. Its first decision is what to do
    ...
    return "\n\n".join(
        [
            ...
            _block(
                "WHAT YOU HAVE ALREADY DONE (your own acts, and how they ended)",
                context.get("your_actions_so_far"),
            ),
            _block("HOW MANY TIMES YOU HAVE TAKEN EACH ACTION", context.get("your_action_counts")),
            "This is your own record of what you have done, not something you were told.",
            "Read it before choosing: doing again what you have already done changes",
            "nothing unless something has changed since, and if you do repeat yourself,",
            "say in your reasoning what makes this time different.",
